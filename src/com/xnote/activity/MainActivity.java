...
public class MainActivity extends Activity implements
	...
	private static final int MENU_SET_PASSWORD = Menu.FIRST + 4;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(Menu.NONE, MENU_DELETE, 4, R.string.delete).setIcon(
				...
				// 设置密码
		menu.add(Menu.NONE, MENU_SET_PASSWORD, 8, R.string.set_password).setIcon(
				R.drawable.lock);;
		// 关于
		menu.add(Menu.NONE, MENU_ABOUT, 9, R.string.about).setIcon(
				R.drawable.about);;
