	...
	private void initViews() {
		...
		ib_bgcolor.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				ImageButton smallstar = (ImageButton) view.findViewById(R.id.smallstar);
				ImageButton smallheart = (ImageButton) view.findViewById(R.id.smallheart);
				ImageButton smallcolor = (ImageButton) view.findViewById(R.id.smallcolor);
				ImageButton smallsummer = (ImageButton) view.findViewById(R.id.smallsummer);
				...
				Button.OnClickListener listener = new Button.OnClickListener() {
					...
					public void onClick(View v) {
						...
						case R.id.smallstar:
							mBackgroud_Color = R.drawable.item_star;
							et_content.setBackgroundResource(mBackgroud_Color);
							// 设置标题栏的背景图片
							mLinearLayout_Header
									.setBackgroundResource(R.drawable.notes_header_pink);
							MyLog.d(MainActivity.TAG, "NoteActivity==>选择了star:"
									+ mBackgroud_Color);
							break;
						case R.id.smallheart:
							mBackgroud_Color = R.drawable.item_heart;
							et_content.setBackgroundResource(mBackgroud_Color);
							// 设置标题栏的背景图片
							mLinearLayout_Header
									.setBackgroundResource(R.drawable.notes_header_yellow);
							MyLog.d(MainActivity.TAG, "NoteActivity==>选择了heart:"
									+ mBackgroud_Color);
							break;
						case R.id.smallcolor:
							mBackgroud_Color = R.drawable.item_color;
							et_content.setBackgroundResource(mBackgroud_Color);
							// 设置标题栏的背景图片
							mLinearLayout_Header
									.setBackgroundResource(R.drawable.notes_header_green);
							MyLog.d(MainActivity.TAG, "NoteActivity==>选择了color:"
									+ mBackgroud_Color);
							break;
							
						case R.id.smallsummer:
							mBackgroud_Color = R.drawable.item_summer;
							et_content.setBackgroundResource(mBackgroud_Color);
							// 设置标题栏的背景图片
							mLinearLayout_Header
									.setBackgroundResource(R.drawable.notes_header_gray);
							MyLog.d(MainActivity.TAG, "NoteActivity==>选择了summer:"
									+ mBackgroud_Color);
							break;	
				...
				smallstar.setOnClickListener(listener);
				smallheart.setOnClickListener(listener);
                smallcolor.setOnClickListener(listener);
                smallsummer.setOnClickListener(listener);
				dialog.show();
			}
		});
