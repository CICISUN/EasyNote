			...
			Button.OnClickListener listener = new Button.OnClickListener() {
				...
				public void onClick(View v) {
					...
					case R.id.white:
						...
						break;
					case R.id.smallstar:
						mBackgroud_Color = R.drawable.widget_small_star;
						et_widget_content
								.setBackgroundResource(R.drawable.item_light_white);
						// 设置标题栏的背景图片
						mLinearLayout_Header
					...
					case R.id.smallheart:
						mBackgroud_Color = R.drawable.widget_small_heart;
						et_widget_content
								.setBackgroundResource(R.drawable.item_light_white);
						// 设置标题栏的背景图片
						mLinearLayout_Header
					...
					case R.id.smallsummer:
						mBackgroud_Color = R.drawable.widget_small_summer;
						et_widget_content
								.setBackgroundResource(R.drawable.item_light_white);
						// 设置标题栏的背景图片
						mLinearLayout_Header
					...
					case R.id.smallcolor:
						mBackgroud_Color = R.drawable.widget_small_color;
						et_widget_content
								.setBackgroundResource(R.drawable.item_light_white);
						// 设置标题栏的背景图片
						mLinearLayout_Header
